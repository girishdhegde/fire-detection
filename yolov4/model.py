...
class YOLOLayer(nn.Module):
    def __init__(self, anchors, nc, img_size, yolo_index, layers, stride):
        ...
        self.anchor_wh = (self.anchors / self.stride).view(1, self.na, 1, 1, 2)
...
class Darknet(nn.Module):
    ...
    def __init__(self, cfg, img_size=(416, 416)):
        ...
        self.module_list, self.routs = create_modules(parse_model_cfg(cfg), img_size, cfg)
    ...
    def forward(self, x):
        ...
        for i, module in enumerate(self.module_list):
            ...
            if name in ['WeightedFeatureFusion', 'FeatureConcat']:  # sum
